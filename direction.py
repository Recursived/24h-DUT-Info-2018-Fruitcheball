...
def getReturnString(data):
	...
	return getDirection(players[0],fruits,data)+"-"+getDirection(players[1],fruits,data)+"-"+getDirection(players[2],fruits,data)+"\n"
